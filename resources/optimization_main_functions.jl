function load_results(filenames; base_folder=results_folder_phase1,
...
function get_run_indices(dfs, run, n_algorithms=n_algorithms_phase1)
...
function get_traces(pfs, x, y, draw_dominated=true,
               names=all_algorithms_phase1, colorscale="viridis", colors=nothing,
